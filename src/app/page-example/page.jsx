...
export default function PageExample() {
  ...
  return (
    <div className="relative justify-center items-center bg-primary-500">
      <section>
        <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center ">
          ...
          >
            ...
            <h1 className="text-4xl font-extrabold mx-auto md:text-5xl   text-background bg-clip-text">
              Use Nextjs and{" "}
              <span className="text-background bg-clip-text border-none">
                NextUI
              </span>{" "}
              to build your website
            </h1>
            <p className="max-w-2xl mx-auto text-background/80">
