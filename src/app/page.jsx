...
export default function Home() {
  ...
  return (
    <div className="testing relative justify-center items-center bg-blue-50">
      <section>
          ...
          >
            ...
            <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
              <motion.div whileHover={{ scale: 1.05 }}>
                <Button onPress={onOpen} className="bg-blue-400 text-primary-foreground" variant="solid">
                  Get Started
                </Button>
                <Modal
                  isOpen={isOpen}
